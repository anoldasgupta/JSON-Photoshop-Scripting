...
<javascriptresource>
<name>Get Font PostScript Name...</name>
<about>"Get Font PostScript Name" v4.0

Get the PostScript name of a font selected by family and style, presented in the same way they are displayed in the character palette or in the type tool bar.
...
//  - Added tool tips to the dialog's main fields.
...
{
	var dialog = new Window ('dialog', "Get Font PostScript Name");
	...
	function onFamilyMenuChange ()
	{
		...
		postScriptNameArea.text = fontsObj[fontFamily][dialog.fontStyleMenu.selection.text]["postScriptName"];
	};
	...
	var doneButton = dialog.add ('button', undefined, 'Done', { name: "ok" });
...
// Requires: support for dropDownList controls and proper dialog auto-layout...
