...
<about>"Preview Custom Shapes File" v2.3
...
function displayDialog ()
{
	...
	cellColumnsSlider.onChanging = cellColumnsSlider.onChange = function ()
	{
		cellColumnsText.text = customOptions.cellColumns = Math.round (this.value);
		updateInfo ();
	};
	...
	var cellSizeSlider = cellSizeGroup.add ("slider", undefined, Math.round (Math.log (customOptions.cellSize) / Math.log (2)), 5, 10);
	cellSizeSlider.size = [ 128, 16 ];
	cellSizeSlider.onChanging = cellSizeSlider.onChange = function ()
	{
		cellSizeText.text = customOptions.cellSize = Math.round (Math.pow (2, Math.round (this.value)));
		this.value = Math.round (Math.log (customOptions.cellSize) / Math.log (2));
		updateInfo ();
	};
	...
	cellSpacingSlider.onChanging = cellSpacingSlider.onChange = function ()
	{
		cellSpacingText.text = customOptions.cellSpacing = Math.round (this.value);
		updateInfo ();
	};
	...
	cellPaddingSlider.onChanging = cellPaddingSlider.onChange = function ()
	{
		cellPaddingText.text = customOptions.cellPaddingPercent = Math.round (this.value);
	};
