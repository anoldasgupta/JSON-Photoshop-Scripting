...
//  1.3:
//  - Reworded "Add Trailing Break" to "Append trailing Break".
//  1.2:
...
function displayDialog ()
{
	...
	dialog.onShow = function ()
	{
		...
		appendTrailingBreakCheck.value = customOptions.appendTrailingBreak;
	...
	var appendTrailingBreakCheck = optionsGroup.add ('checkbox', undefined, 'Append Trailing Break');
	...
	reformatButton.onClick = function ()
	{
		try
		{
			jsonArea.text = jamJSON.stringify (jamJSON.parse (jsonArea.text, strictValidationCheck.value), expandTabsCheck.value ? 4 : '\t')
							+
							(appendTrailingBreakCheck.value ? "\n" : "");
	...
	okButton.onClick = function ()
	{
		...
		customOptions.appendTrailingBreak = appendTrailingBreakCheck.value;
